...
export class Migration1774421861626 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_type_enum" AS ENUM('FOLLOW', 'CONNECTION_REQUEST', 'CONNECTION_ACCEPTED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_d1e9b2452666de3b9b4d271cca" ON "notifications" ("receiverId") `,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX "public"."IDX_d1e9b2452666de3b9b4d271cca"`,
    );
    await queryRunner.query(
